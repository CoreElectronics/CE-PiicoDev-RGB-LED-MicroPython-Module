...
const uint8_t powerLedPin = PIN_PA6; // TODO update
...
// squash spurious LED power-on behaviour
delay(1);leds.clear();leds.show();delay(1);
...
//      Serial.println(registerMap.control.clearLedFlag);
    ...
    if (registerMap.control.pwrLedCtl != lastPowerLed){
      ...
      digitalWrite(powerLedPin, registerMap.control.pwrLedCtl);
    }
